...
class InstagramAuth { 
    ...
    public function getAuthURL(){ 
        ...
        $authURL = "https://api.instagram.com/oauth/authorize?client_id=". $this->client_id ."&redirect_uri=". urlencode($this->redirect_url) ."&scope=user_profile,user_media&response_type=code"; 
        return $authURL; 
    } 
